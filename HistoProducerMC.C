...
//     MCLabel.push_back ( "Selection MC BNB+Cosmic Sys. Error" );
    ...
    ChainVec.back() -> Add ( "/lheppc46/data/uBData/anatrees/"+Folder+"/Hist_MC_Truth_prodgenie_bnb_nu_cosmic_uboone_v05_08_00.root" );
