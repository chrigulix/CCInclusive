...
//         SelectionMomentum.back() -> GetYaxis() -> SetTitle("d#sigma/dp [cm^{2}/(GeV/c)]");
    ...
    for(unsigned int file_no = 0; file_no < BgrTrackRange.size(); file_no++)
    {
        ...
        {
            BgrTrackRange.at(file_no).push_back(new TH1F((Label+"Range_"+std::to_string(file_no)).c_str(),"Range",NumberOfBins,0,1036.8));
            BgrCosTheta.at(file_no).push_back(new TH1F((Label+"cos#theta_"+std::to_string(file_no)).c_str(),"cos#theta",NumberOfBins,-1,1));
            BgrTheta.at(file_no).push_back(new TH1F((Label+"#theta_"+std::to_string(file_no)).c_str(),"#theta",NumberOfBins,0,180));
            BgrPhi.at(file_no).push_back(new TH1F((Label+"#phi_"+std::to_string(file_no)).c_str(),"#phi",NumberOfBins,-180,180));
            BgrMomentum.at(file_no).push_back(new TH1F((Label+"Momentum_"+std::to_string(file_no)).c_str(),"Momentum",NumberOfBins,0,3));
...
//             }
    ...
    // Loop over all background histograms
    for(unsigned int hist_no = 0; hist_no < BgrTrackRange.size(); hist_no++)
    {
        SubtractBgr(SelectionTrackRange,BgrTrackRange,hist_no+2,hist_no,1);
        SubtractBgr(SelectionCosTheta,BgrCosTheta,hist_no+2,hist_no,1);
        SubtractBgr(SelectionTheta,BgrTheta,hist_no+2,hist_no,1);
        SubtractBgr(SelectionPhi,BgrPhi,hist_no+2,hist_no,1);
        SubtractBgr(SelectionMomentum,BgrMomentum,hist_no+2,hist_no,1);
    }
    ...
    SubtractBgr(SelectionTrackRange,BgrTrackRange,0,0,1);
    SubtractBgr(SelectionCosTheta,BgrCosTheta,0,0,1);
    SubtractBgr(SelectionTheta,BgrTheta,0,0,1);
    SubtractBgr(SelectionPhi,BgrPhi,0,0,1);
    SubtractBgr(SelectionMomentum,BgrMomentum,0,0,1);
...
//     CalcSigEfficiency(SelectionMomentum);
    ...
    SelectionTrackRange.at(2)->SetMarkerStyle(1);
    SelectionTrackRange.at(2)->SetMarkerColor(46);
    SelectionTrackRange.at(2)->Draw("E2 SAME");
    SelectionTrackRange.at(3)->SetFillColorAlpha(28,0.3);
    SelectionTrackRange.at(3)->SetMarkerStyle(1);
    ...
    SelectionTrackRange.at(4)->SetMarkerStyle(1);
    SelectionTrackRange.at(4)->SetMarkerColor(30);
    SelectionTrackRange.at(4)->Draw("E2 SAME");
    SelectionTrackRange.at(5)->SetFillColorAlpha(38,0.3);
    SelectionTrackRange.at(5)->SetMarkerStyle(1);
    SelectionTrackRange.at(5)->SetMarkerColor(38);
    SelectionTrackRange.at(5)->Draw("E2 SAME");
    SelectionTrackRange.at(0)->SetLineWidth(2);
    SelectionTrackRange.at(0)->SetLineColor(1);
    SelectionTrackRange.at(0)->SetMarkerStyle(8);
    ...
    SelectionCosTheta.at(2)->SetMarkerStyle(1);
    SelectionCosTheta.at(2)->SetMarkerColor(46);
    SelectionCosTheta.at(2)->Draw("E2");
    SelectionCosTheta.at(3)->SetFillColorAlpha(28,0.3);
    SelectionCosTheta.at(3)->SetMarkerStyle(1);
    ...
    SelectionCosTheta.at(4)->SetMarkerStyle(1);
    SelectionCosTheta.at(4)->SetMarkerColor(30);
    SelectionCosTheta.at(4)->Draw("E2 SAME");
    SelectionCosTheta.at(5)->SetFillColorAlpha(38,0.3);
    SelectionCosTheta.at(5)->SetMarkerStyle(1);
    SelectionCosTheta.at(5)->SetMarkerColor(38);
    SelectionCosTheta.at(5)->Draw("E2 SAME");
    SelectionCosTheta.at(0)->SetLineWidth(2);
    SelectionCosTheta.at(0)->SetMarkerStyle(8);
    ...
    SelectionMomentum.at(2)->SetMarkerStyle(1);
    SelectionMomentum.at(2)->SetMarkerColor(46);
    SelectionMomentum.at(2)->Draw("E2");
    SelectionMomentum.at(3)->SetFillColorAlpha(28,0.3);
    SelectionMomentum.at(3)->SetMarkerStyle(1);
    ...
    SelectionMomentum.at(4)->SetMarkerStyle(1);
    SelectionMomentum.at(4)->SetMarkerColor(30);
    SelectionMomentum.at(4)->Draw("E2 SAME");
    SelectionMomentum.at(5)->SetFillColorAlpha(38,0.3);
    SelectionMomentum.at(5)->SetMarkerStyle(1);
    SelectionMomentum.at(5)->SetMarkerColor(38);
    SelectionMomentum.at(5)->Draw("E2 SAME");
    SelectionMomentum.at(0)->SetLineWidth(2);
    SelectionMomentum.at(0)->SetLineColor(1);
    SelectionMomentum.at(0)->SetMarkerStyle(8);
